classdef interrupt_testing5 < handle
    %
    %   Class:
    %   interrupt_testing5
    %
    ...
    interrupt_testing5()
    interrupt_testing5.launchTimer()
    ...
    methods
        function obj = interrupt_testing5(use_guide)
            if nargin == 0
                use_guide = false;
            end
            if use_guide
                ...
                obj.timer = timer(); %#ok<PROP>
                obj.timer.ExecutionMode = 'fixedSpacing';
                obj.timer.TasksToExecute = 3;
                obj.timer.Period = 3;
